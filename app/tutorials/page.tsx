...
const EPISODES = [
  ...
  { num: '12', shortTitle: 'AI Cue Engine', duration: '5 min', category: 'ai', youtubeUrl: 'https://www.youtube.com/watch?v=TE98wtdXehk', accentColor: '#8b5cf6',
  ...
  { num: '13', shortTitle: 'AI Report Generator', duration: '6 min', category: 'ai', youtubeUrl: 'https://www.youtube.com/watch?v=oZwY2JgGap0', accentColor: '#8b5cf6',
  ...
  { num: '14', shortTitle: 'Timeline & Programme', duration: '5–6 min', category: 'signage', youtubeUrl: 'https://www.youtube.com/watch?v=lk71z8RF9v0', accentColor: '#10b981',
  ...
  { num: '15', shortTitle: 'Sponsor Signage', duration: '4–5 min', category: 'signage', youtubeUrl: 'https://www.youtube.com/watch?v=c4AnQanOUJ8', accentColor: '#10b981',
  ...
  { num: '16', shortTitle: 'Event Log', duration: '5 min', category: 'advanced', youtubeUrl: 'https://www.youtube.com/watch?v=kRl2s2Y1lOo', accentColor: '#ef4444',
  ...
  { num: '17', shortTitle: 'Keyboard Shortcuts', duration: '3–4 min', category: 'advanced', youtubeUrl: 'https://www.youtube.com/watch?v=GOpXBCaK7VI', accentColor: '#ef4444',
  ...
  { num: '18', shortTitle: 'Mobile & Tablet', duration: '4–5 min', category: 'advanced', youtubeUrl: 'https://www.youtube.com/watch?v=K4pFwyoJYc0', accentColor: '#ef4444',
  ...
  { num: '19', shortTitle: 'Billing & Plans', duration: '4 min', category: 'advanced', youtubeUrl: 'https://www.youtube.com/watch?v=T6Xbtl8BMhM', accentColor: '#ef4444',
